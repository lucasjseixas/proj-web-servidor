    ...
    <form id="formDocument" action="salvar.php" method="POST">
        <div>
            <div>
                ...
                <input type=" text" class="form-control" name="docName" id=" docName" placeholder="Nome do documento" required>
            </div>
            <label for="textArea" class="form-label mt-4">Documento</label>
            <textarea class="form-control" name="textArea" id="textArea" rows="15" placeholder="Digite seu texto aqui" type="text"></textarea>
        </div>
