...
function gerarTabelaArquivos()
{
  ...
  while (false !== ($arquivo = $diretorio->read())) {
    if ($arquivo != "." && $arquivo != "..") {
      ...
      $tabela .= "<td><button type='submit' class='btn btn-warning btn-sm me-2'>EDITAR<i class='bi bi-pencil'></i></button><button type='submit' class='btn btn-danger btn-sm'>EXCLUIR<i class='bi bi-trash-fill'></i></button></td>";
      $tabela .= "</tr>";
    }
  }
